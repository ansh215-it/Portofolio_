      ...
      <AnimatedWrapper>
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center relative">
          <div className="md:col-span-7 space-y-8">
            <h1 className="text-5xl md:text-7xl font-extrabold leading-[1.1] tracking-tight text-slate-900 transition-colors duration-300 dark:text-textPrimary">
              Software Engineer <br />
              <span className="text-primary block h-[60px] md:h-[120px] mt-2">
                <TypeAnimation
                  sequence={['Ayyub Al Anshor', 2000, 'a Creative Thinker', 2000, 'a Problem Solver', 2000]}
                  wrapper="span"
                  cursor={true}
                  repeat={Infinity}
                />
            ...
            <p className="text-xl text-slate-600 transition-colors duration-300 dark:text-textSecondary max-w-xl">
            ...
            <a href="#contact" className="inline-flex items-center gap-3 text-lg font-semibold text-slate-900 transition-colors duration-300 group dark:text-textPrimary">
              Let's talk
          ...
          <div className="md:col-span-5 flex justify-center md:justify-end relative my-16 md:my-0">
            ...
            <img
              src={profileImage}
              alt="Ayyub Al Anshor"
              className="w-[300px] md:w-[400px] h-[400px] md:h-[500px] object-cover rounded-[30px] shadow-2xl border-2 border-slate-200/70 transition-colors duration-300 dark:border-white/5"
            />
          </div>
        </div>
      </AnimatedWrapper>
